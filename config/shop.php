...
return [
	...
	'resource' => [
		'db' => [
			'adapter' => (config('database.connections.' . config('database.default', 'mysql') . '.driver', 'mysql') === 'sqlite' ? 'pdo_sqlite' : config('database.connections.' . config('database.default', 'mysql') . '.driver', 'mysql')),
...
'path' => config( 'database.connections.' . config( 'database.default', 'mysql' ) . '.database', database_path('database.sqlite') ),
